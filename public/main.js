...
/* harmony import */ var _services_valid_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/valid.service */ "./src/app/services/valid.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_valid_service__WEBPACK_IMPORTED_MODULE_14__["ValidService"]],
...
module.exports = "<!--========== HEADER V2 ==========-->\n        <header class=\"navbar-fixed-top s-header-v2 js__header-sticky\">\n            <!-- Navbar -->\n            <nav class=\"s-header-v2__navbar\">\n                <div class=\"container g-display-table--lg\">\n                    <!-- Navbar Row -->\n                    <div class=\"s-header-v2__navbar-row\">\n                        <!-- Brand and toggle get grouped for better mobile display -->\n                        <div class=\"s-header-v2__navbar-col\">\n                            <button type=\"button\" class=\"collapsed s-header-v2__toggle\" data-toggle=\"collapse\" data-target=\"#nav-collapse\" aria-expanded=\"false\">\n                                <span class=\"s-header-v2__toggle-icon-bar\"></span>\n                            </button>\n                        </div>\n\n                        <div class=\"s-header-v2__navbar-col s-header-v2__navbar-col-width--180\">\n                            <!-- Logo -->\n                            <div class=\"s-header-v2__logo\">\n                                <a [routerLink]=\"['/']\" class=\"s-header-v2__logo-link\">\n                                    <img class=\"s-header-v2__logo-img s-header-v2__logo-img--default\" src=\"assets/img/hammock-logo-sm.png\" alt=\"Hammock Logo\">\n                                    <img class=\"s-header-v2__logo-img s-header-v2__logo-img--shrink\" src=\"assets/img/hammock-logo-sm-1.png\" alt=\"Hammock Logo\">\n                                </a>\n                            </div>\n                            <!-- End Logo -->\n                        </div>\n\n                        <div class=\"s-header-v2__navbar-col s-header-v2__navbar-col--right\">\n                            <!-- Collect the nav links, forms, and other content for toggling -->\n                            <div class=\"collapse navbar-collapse s-header-v2__navbar-collapse\" id=\"nav-collapse\">\n                                <ul class=\"s-header-v2__nav\">\n                                    <!-- Home -->\n                                    <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" class=\"dropdown s-header-v2__nav-item\">\n                                        <a  [routerLink]=\"['/']\"  class=\"s-header-v2__nav-link -is-active\" data-toggle=\"dropdown\" role=\"button\"> Home</a>\n                                    </li>\n                                    <!-- End Home -->\n\n                                    <!-- Pages -->\n                                    <li class=\"dropdown s-header-v2__nav-item s-header-v2__dropdown-on-hover\">\n                                        <a href=\"javascript:void(0);\" class=\"dropdown-toggle s-header-v2__nav-link\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Trade <span class=\"g-font-size-10--xs g-margin-l-5--xs ti-angle-down\"></span></a>\n                                        <ul class=\"dropdown-menu s-header-v2__dropdown-menu\">\n                                            <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a  [routerLink]=\"['/buy-property']\" class=\"s-header-v2__dropdown-menu-link\">Buy Property</a></li>\n                                            <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a [routerLink]=\"['/sell-property']\"  class=\"s-header-v2__dropdown-menu-link\">Sell  Property</a></li>\n                                        </ul>\n                                    </li>\n                                    <!-- End Pages -->\n\n                                    <li class=\"s-header-v2__nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a  [routerLink]=\"['/about']\" class=\"s-header-v2__nav-link\">About</a></li>\n                                    <li class=\"s-header-v2__nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a  [routerLink]=\"['/login']\" class=\"s-header-v2__nav-link\">Sign In</a></li>\n                                    <li class=\"s-header-v2__nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a  [routerLink]=\"['/register']\" class=\"s-header-v2__nav-link\">Create Account</a></li>\n                                    <li class=\"s-header-v2__nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions] = \"{exact:true}\" ><a [routerLink]=\"['/contacts']\" class=\"s-header-v2__nav-link s-header-v2__nav-link--dark\">Contacts</a></li>\n                                </ul>\n                            </div>\n                            <!-- End Nav Menu -->\n                        </div>\n                    </div>\n                    <!-- End Navbar Row -->\n                </div>\n            </nav>\n            <!-- End Navbar -->\n        </header>\n        <!--========== END HEADER V2 ==========-->\n"
...
var RegisterComponent = /** @class */ (function () {
    ...
    function RegisterComponent(validService) {
...
module.exports = __webpack_require__(/*! /home/korede/hyperProjects/hammock-watson/angular-src/src/main.ts */"./src/main.ts");
